...
namespace EmreYildirimTodoWebHW.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Index(SearchViewModel searchModel)
        {
            ...
            if (!searchModel.CategoryDescSearch && !String.IsNullOrWhiteSpace(searchModel.SearchText))
            {
                query = query.Where(t => t.Name.Contains(searchModel.SearchText));
               
            }
            else if (searchModel.CategoryDescSearch && !String.IsNullOrWhiteSpace(searchModel.SearchText))
            {
                query = query.Where(t => t.Desc.Contains(searchModel.SearchText) || t.Name.Contains(searchModel.SearchText));
            }
